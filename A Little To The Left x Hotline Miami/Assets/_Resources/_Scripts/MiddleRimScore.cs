...
public class MiddleRimScore : MonoBehaviour
{
   public float delay = 10f;
    ...
    void OnTriggerStay2D(Collider2D other)
    {
        ...
        {
            scoretallyobj.GetComponent<ScoreTracker>().score += 10;
        ...
        {
            scoretallyobj.GetComponent<ScoreTracker>().score += 5;
            alreadychecked = true;
        }
        ...
        {
            scoretallyobj.GetComponent<ScoreTracker>().score += 15;
            alreadychecked = true;
        }
